...
RSpec.describe HomesController, :type => :controller do
  ...
  let(:valid_attributes) { {address: "123 Foo St", city: City.create(name: "New York")} }

  let(:invalid_attributes) { {address: nil, city: nil} }
