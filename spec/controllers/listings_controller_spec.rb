...
RSpec.describe ListingsController, :type => :controller do
  ...
  let(:valid_attributes) do
    {home_id: FactoryGirl.create(:home).id, start_date: 2.weeks.ago.to_date, end_date: 2.weeks.from_now.to_date}
  end

  let(:invalid_attributes) { {home: nil, start_date: nil, end_date: nil} }
  ...
  describe "PUT update" do
    describe "with valid params" do
      let(:new_attributes) { {end_date: 3.weeks.from_now.to_date} }

      it "updates the requested listing" do
        listing = Listing.create! valid_attributes
        put :update, {:id => listing.to_param, :listing => new_attributes}, valid_session
        listing.reload
        expect(listing.end_date).to eq(new_attributes[:end_date])
      end
